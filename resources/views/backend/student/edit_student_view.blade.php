        ...
        <div class="card-body">
            ...
            <form action="{{ route('update.student',$student->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" required type="text" name="full_name" value="{{ $student->name }}">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="example-text-input" class="col-sm-2 col-form-label">Roll Id</label>
                    <div class="col-sm-10">
                        <input class="form-control" type="text" name="roll_id" value="{{ $student->roll_id }}" required>
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" required type="date" name="dob" value="{{ $student->dob }}">
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        {{-- real time image --}}
                        <img id="ShowImage" src="{{ empty($student->photo)? asset('uploads/no_uploaded.png') : asset('uploads/student_photos/'. $student->photo) }}" alt="avatar-4" class="rounded avatar-md">
                    </div>
                </div>
                <!-- end row -->
