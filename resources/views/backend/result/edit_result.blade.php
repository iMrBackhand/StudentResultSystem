...
<div class="card">
    <div class="card-body">
        ...
        <h4 class="card-title">Update A Student Result </h4>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <h6 style="padding-top: 10px; font-style:italic">{{ $result[0]->student->class->class_name }} Section - {{ $result[0]->student->class->section }}</h6>
            </div>
        </div>
        ...
        <!-- end row -->
        <button type="submit" class="btn btn-primary waves-effect waves-light">Update Results</button>
        </form>
    </div>
