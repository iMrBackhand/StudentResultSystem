    ...
    <div class="card-body">
        ...
        <div class="show_item">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-7">
                    {{-- subject_ids allow us to store multiple id --}}
...
{{-- hidden form for adding a column --}}
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.remove_subject_btn', function(e) { // Added '.' before 'remove_subject_btn' and added a comma
            e.preventDefault();
